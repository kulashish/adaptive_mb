...
public class MartiBoost {
	...
	private static String TRAIN_FILE = "/Users/ashish/Documents/personal/phd/Interactive MB/webspam-2sample-train/webspam_wc_normalized_unigram-2-SAMPLE-train-11.arff";
	private static String HOLDOUT_FILE = "/Users/ashish/Documents/personal/phd/Interactive MB/webspam-2sample-holdout/webspam_wc_normalized_unigram-2-SAMPLE-holdout-11.arff";
	private static String TEST_FILE = "/Users/ashish/Documents/personal/phd/Interactive MB/webspam-2sample-test/webspam_wc_normalized_unigram-2-SAMPLE-test-1.arff";
	...
	public static void main(String[] args) {
		...
		try {
			...
			mBoost = new MartiBoost(TRAIN_FILE, HOLDOUT_FILE, 5);
			mBoost.build();
			long end = System.currentTimeMillis();
			System.out.println("Elapsed time : " + (end - start));
			// mBoost.evaluateTestData(mBoost.getRoot(), TEST_FILE);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
