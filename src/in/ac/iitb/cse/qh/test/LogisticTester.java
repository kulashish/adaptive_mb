...
public class LogisticTester {
	...
	public static void main(String[] args) throws Exception {
		...
		DataSource source;
		source = new DataSource("/Users/ashish/Dropbox/Public/Dataset/spam-train/uci-train-22.arff");
		trainInstances = source.getDataSet();
		Instances testInstances = new DataSource("/Users/ashish/Dropbox/Public/Dataset/spam-test/uci-test-2.arff")
				.getDataSet();
		...
		double dist[][] = new double[testInstances.numInstances()][testInstances.numClasses()];
